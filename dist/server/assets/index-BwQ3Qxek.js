import { r as reactExports, T as jsxRuntimeExports } from "./worker-entry-OtEtI02j.js";
import "node:events";
...
const PresenceChild = ({ children, initial: initial2, isPresent, onExitComplete, custom, presenceAffectsLayout, mode, anchorX, anchorY, root }) => {
...
const AnimatePresence = ({ children, custom, initial: initial2 = true, onExitComplete, presenceAffectsLayout = true, mode = "sync", propagate = false, anchorX = "left", anchorY = "top", root }) => {
  ...
  return jsxRuntimeExports.jsx(jsxRuntimeExports.Fragment, { children: renderedChildren.map((child) => {
    ...
    return jsxRuntimeExports.jsx(PresenceChild, { isPresent, initial: !isInitialRender.current || initial2 ? void 0 : false, custom, presenceAffectsLayout, mode, root, onExitComplete: isPresent ? void 0 : onExit, anchorX, anchorY, children: child }, key);
  }) });
};
...
function useCreateMotionContext(props) {
  const { initial: initial2, animate } = getCurrentTreeVariants(props, reactExports.useContext(MotionContext));
  return reactExports.useMemo(() => ({ initial: initial2, animate }), [variantLabelsAsDependency(initial2), variantLabelsAsDependency(animate)]);
}
...
function makeLatestValues(props, context, presenceContext, scrapeMotionValues) {
  ...
  let { initial: initial2, animate } = props;
  const isControllingVariants$1 = isControllingVariants(props);
  const isVariantNode$1 = isVariantNode(props);
  if (context && isVariantNode$1 && !isControllingVariants$1 && props.inherit !== false) {
    if (initial2 === void 0)
      initial2 = context.initial;
    if (animate === void 0)
      animate = context.animate;
  }
  let isInitialAnimationBlocked = presenceContext ? presenceContext.initial === false : false;
  isInitialAnimationBlocked = isInitialAnimationBlocked || initial2 === false;
  const variantToSet = isInitialAnimationBlocked ? animate : initial2;
  ...
  update() {
    ...
    if (isPresent && prevIsPresent === false) {
      if (this.isExitComplete) {
        const { initial: initial2, custom } = this.node.getProps();
        if (typeof initial2 === "string") {
          const resolved = resolveVariant(this.node, initial2, custom);
          if (resolved) {
            const { transition, transitionEnd, ...target } = resolved;
            for (const key in target) {
...
class PanSession {
   ...
   */
  handleScroll(target) {
    const initial2 = this.scrollPositions.get(target);
    if (!initial2)
      return;
    ...
    const delta = { x: current.x - initial2.x, y: current.y - initial2.y };
...
function TypewriterText({ text, speed = 55, className, onDone, startDelay = 0 }) {
  const [shown, setShown] = reactExports.useState("");
  const [started, setStarted] = reactExports.useState(startDelay === 0);
  reactExports.useEffect(() => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className, children: [
    shown,
    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "inline-block w-[2px] h-[0.9em] align-middle ml-1 bg-current opacity-70 animate-pulse" })
  ] });
}
function Sparkles({ count = 30 }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "pointer-events-none absolute inset-0 overflow-hidden", children: sparkles.map((s) => /* @__PURE__ */ jsxRuntimeExports.jsx(
    "div",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          motion.div,
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-script text-3xl md:text-4xl text-rose-400 mb-4", style: { color: "oklch(0.7 0.18 350)" }, children: "a little surprise just for you..." }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("h1", { className: "font-display text-5xl md:text-7xl lg:text-8xl font-bold leading-tight text-gradient-rose", children: [
                "Happy Birthday",
                /* @__PURE__ */ jsxRuntimeExports.jsx("br", {}),
                "Surbhi ",
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "inline-block animate-drift", children: "💖" })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-8 text-lg md:text-2xl font-script min-h-[3rem]", style: { color: "oklch(0.5 0.1 350)" }, children: /* @__PURE__ */ jsxRuntimeExports.jsx(TypewriterText, { text: "Today the whole world celebrates the most magical soul — you ✨", startDelay: 1200 }) }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs(
                motion.button,
                {
                  onClick: onEnter,
                  ...
                  children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "absolute inset-0 rounded-full overflow-hidden", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "absolute inset-0 animate-shimmer opacity-60" }) }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx(Gift, { className: "h-5 w-5 relative z-10" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "relative z-10", children: "Tap to Enter Surprise" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "relative z-10", children: "🎁" })
                  ]
                }
              ),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-6 text-xs uppercase tracking-[0.3em]", style: { color: "oklch(0.6 0.08 350)" }, children: "turn up your sound 🎵" })
            ]
          }
        )
      ]
...
function SectionShell({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { id: id2, className: "relative min-h-screen py-24 px-6 flex flex-col items-center justify-center", children: [
    (title || subtitle) && /* @__PURE__ */ jsxRuntimeExports.jsxs(
      motion.div,
      {
        ...
        children: [
          subtitle && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-script text-2xl md:text-3xl mb-2", style: { color: "oklch(0.7 0.16 350)" }, children: subtitle }),
          title && /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display text-4xl md:text-6xl font-bold text-gradient-rose", children: title })
        ]
      }
    ),
...
const pic1 = "/assets/pic1-DhwqHo7F.jpg";
const pic2 = "/assets/pic2-BH82Efsw.jpg";
const pic3 = "/assets/pic3-Ovxn8byl.jpg";
const pic4 = "/assets/pic4-Cg0IFTUZ.jpg";
const pic5 = "/assets/pic5-BguKcwCL.jpg";
const pic6 = "/assets/pic6-CF8rspQS.jpg";
const photos = [
...
function DedicatedGallery() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "py-16", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-4xl md:text-5xl font-bold text-center mb-10", children: "💖 My Girl 💖" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-2 md:grid-cols-3 gap-6 md:gap-10", children: photos.map((m, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
      motion.div,
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "aspect-square rounded-xl overflow-hidden", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
            "img",
            {
              src: m.img,
              alt: m.caption,
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-center mt-3 text-lg", children: m.caption })
        ]
      },
      i
    )) })
...
(function main(global, module, isWorker, workerSize) {
  ...
  function colorsToRgb(colors2) {
    return colors2.map(hexToRgb);
  }
  ...
  function confettiCannon(canvas, globalOpts) {
    ...
    function fireLocal(options, size, done) {
      ...
      var colors2 = prop(options, "colors", colorsToRgb);
      ...
      while (temp--) {
        fettis.push(
          randomPhysics({
            ...
            spread,
            startVelocity,
            color: colors2[temp % colors2.length],
  ...
  function shapeFromText(textData) {
    var text, scalar = 1, color2 = "#000000", fontFamily = '"Apple Color Emoji", "Segoe UI Emoji", "Segoe UI Symbol", "Noto Color Emoji", "EmojiOne Color", "Android Emoji", "Twemoji Mozilla", "system emoji", sans-serif';
...
function Balloons() {
  const [balloons, setBalloons] = reactExports.useState(initial);
  const pop = (id2) => {
    confetti({
      particleCount: 60,
      spread: 70,
    ...
    try {
      ...
      g.gain.exponentialRampToValueAtTime(1e-3, ctx.currentTime + 0.2);
      o.connect(g);
    ...
    setBalloons((b) => b.filter((x) => x.id !== id2));
  };
  const reset = () => setBalloons(initial);
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative h-[60vh] w-full glass rounded-3xl overflow-hidden", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(AnimatePresence, { children: balloons.map((b) => /* @__PURE__ */ jsxRuntimeExports.jsx(
      motion.button,
      {
        onClick: () => pop(b.id),
        ...
        children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-px h-16 mx-auto", style: { background: "oklch(0.5 0.05 350 / 0.4)" } })
        ] })
      },
      b.id
    )) }),
    balloons.length === 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "absolute inset-0 flex flex-col items-center justify-center gap-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-script text-3xl", style: { color: "oklch(0.6 0.15 350)" }, children: "you popped them all! 🎉" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "button",
        {
          onClick: reset,
          ...
          children: "Send More Balloons 🎈"
        }
      )
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "absolute top-4 left-1/2 -translate-x-1/2 font-script text-xl pointer-events-none", style: { color: "oklch(0.6 0.12 350)" }, children: "tap the balloons 💕" })
  ] });
}
function Cake() {
  const [cut, setCut] = reactExports.useState(false);
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col items-center gap-8", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative h-[420px] w-full max-w-md", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        motion.div,
        {
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "absolute bottom-0 left-1/2 -translate-x-1/2 w-72 h-72", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          motion.div,
          {
            ...
            children: [
              cut && /* @__PURE__ */ jsxRuntimeExports.jsx(
                motion.div,
                {
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute top-0 left-0 right-0 h-3", style: { background: "linear-gradient(90deg, oklch(0.95 0.06 5), oklch(0.92 0.1 350), oklch(0.95 0.06 5))" } })
            ]
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute top-0 left-0 right-0 h-2 rounded-t-2xl", style: { background: "oklch(0.98 0.03 340)" } }),
              [0, 1, 2, 3, 4].map((i) => /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute top-2 w-3 h-6 rounded-b-full", style: { left: `${10 + i * 20}%`, background: "oklch(0.78 0.16 350)" } }, i))
            ]
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            ...
            children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute top-0 left-0 right-0 h-2 rounded-t-2xl", style: { background: "oklch(0.99 0.02 5)" } })
          }
        ),
        [0, 1, 2].map((i) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "absolute", style: { bottom: "280px", left: `calc(50% - 36px + ${i * 30}px)` }, children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-2 h-10 rounded-sm", style: { background: "linear-gradient(180deg, oklch(0.85 0.12 350), oklch(0.7 0.18 5))" } }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(AnimatePresence, { children: !cut && /* @__PURE__ */ jsxRuntimeExports.jsx(
            motion.div,
            {
              initial: { scale: 0 },
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "button",
      {
        ...
        children: cut ? "🎉 Yay! Make a wish 💖" : "Cut the Cake 🎂"
      }
    ),
    /* @__PURE__ */ jsxRuntimeExports.jsx(AnimatePresence, { children: showWish && /* @__PURE__ */ jsxRuntimeExports.jsxs(
      motion.div,
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-script text-3xl md:text-4xl text-gradient-rose", children: "Make a wish, beautiful 💖" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-2 text-sm", style: { color: "oklch(0.5 0.08 350)" }, children: "...close your eyes ✨" })
        ]
      }
    ) })
  ] });
...
function Messages() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid gap-6 md:gap-8", children: messages.map((m, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(
    motion.div,
    {
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-script text-2xl md:text-3xl text-gradient-rose", children: m })
    },
    i
  )) });
}
function GiftBox() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-col items-center gap-8", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative h-72 w-72", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(AnimatePresence, { children: !open ? /* @__PURE__ */ jsxRuntimeExports.jsxs(
      motion.button,
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute top-6 left-1/2 -translate-x-1/2 w-56 h-16 rounded-xl gradient-rose shadow-[var(--shadow-petal)]" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "div",
            {
              className: "absolute top-20 left-1/2 -translate-x-1/2 w-52 h-44 rounded-xl shadow-[var(--shadow-petal)]",
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "div",
            {
              className: "absolute top-6 left-1/2 -translate-x-1/2 w-6 h-58 h-[15rem]",
              style: { background: "linear-gradient(180deg, oklch(0.96 0.06 60), oklch(0.88 0.1 50))" }
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute top-0 left-1/2 -translate-x-1/2 text-5xl", children: "🎀" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "absolute -bottom-2 left-1/2 -translate-x-1/2 font-script text-xl whitespace-nowrap", style: { color: "oklch(0.55 0.12 350)" }, children: "tap to open 💝" })
        ]
      },
      "box"
    ) : /* @__PURE__ */ jsxRuntimeExports.jsx(
      motion.div,
      {
        ...
        children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "glass rounded-3xl p-8 text-center max-w-sm", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-6xl mb-3 animate-drift", children: "💖" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-script text-3xl text-gradient-rose", children: "My biggest gift is you" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-2 text-sm", style: { color: "oklch(0.5 0.08 350)" }, children: "thank you for existing in my life ✨" })
        ] })
      },
      "opened"
    ) }),
    open && ["💖", "🌸", "✨", "💕", "🎀", "🌷", "💫", "🤍"].map((e, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(
      motion.span,
      {
...
function CuteGifs() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-2 md:grid-cols-3 gap-6", children: items.map((it, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
    motion.div,
    {
      animate: { y: [0, -12, 0] },
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-7xl mb-3", style: { filter: "drop-shadow(0 8px 16px oklch(0.7 0.15 350 / 0.4))" }, children: it.e }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-script text-xl", style: { color: "oklch(0.55 0.12 350)" }, children: it.label })
      ]
    },
    i
  )) });
...
function FinalScreen({ onReplay }) {
  const drops = reactExports.useMemo(
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "relative min-h-screen flex flex-col items-center justify-center text-center px-6 overflow-hidden", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "div",
      {
        className: "absolute inset-0 pointer-events-none",
        style: {
          background: "radial-gradient(circle at 50% 40%, oklch(0.95 0.12 350 / 0.6), transparent 60%), radial-gradient(circle at 50% 60%, oklch(0.92 0.1 5 / 0.5), transparent 70%)"
        }
      }
    ),
    drops.map((d) => /* @__PURE__ */ jsxRuntimeExports.jsx(
      "span",
      {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      motion.div,
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-script text-3xl md:text-4xl mb-4", style: { color: "oklch(0.6 0.16 350)" }, children: "and finally..." }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display text-5xl md:text-7xl font-bold text-gradient-rose leading-tight", children: "I like You Alot  💕" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "mt-6 text-base md:text-lg", style: { color: "oklch(0.45 0.08 350)" }, children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "button",
            {
              ...
              children: "Replay the Magic ↺"
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-8 font-script text-xl", style: { color: "oklch(0.6 0.12 350)" }, children: "made by gautam  with all my love 💖" })
        ]
      }
    )
  ] });
}
const song = "/assets/TumhoToh-DL71gZLP.mp3";
function MusicToggle() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("audio", { ref, src: song, loop: true, preload: "auto" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "button",
      {
        onClick: toggle,
        className: "fixed top-5 right-5 z-50 glass rounded-full p-3 hover:scale-110 transition-transform",
        children: playing ? /* @__PURE__ */ jsxRuntimeExports.jsx(Volume2, { className: "h-5 w-5 text-rose-500" }) : /* @__PURE__ */ jsxRuntimeExports.jsx(VolumeX, { className: "h-5 w-5 text-gray-500" })
      }
    )
  ] });
}
function Experience({ onReplay }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    motion.div,
    {
      initial: { opacity: 0, y: 40 },
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(SectionShell, { subtitle: "welcome to your day", title: "It's All About You Today 🌸", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "glass rounded-3xl p-8 md:p-14 text-center max-w-3xl mx-auto", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
          "p",
          {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(SectionShell, { subtitle: "for you 💕", title: "Dedicated To You 💖", children: /* @__PURE__ */ jsxRuntimeExports.jsx(DedicatedGallery, {}) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(SectionShell, { subtitle: "a little fun", title: "Pop the Balloons 🎈", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Balloons, {}) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(SectionShell, { subtitle: "the main event", title: "Cut Your Cake 🎂", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Cake, {}) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(SectionShell, { subtitle: "words from my heart", title: "Just for You 💌", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Messages, {}) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(SectionShell, { subtitle: "a tiny surprise", title: "Open Your Gift 🎁", children: /* @__PURE__ */ jsxRuntimeExports.jsx(GiftBox, {}) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(SectionShell, { subtitle: "because you're adorable", title: "Cute Things For Cute You 🧸", children: /* @__PURE__ */ jsxRuntimeExports.jsx(CuteGifs, {}) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(FinalScreen, { onReplay })
      ]
    }
  );
}
function FloatingHearts({ count = 18, emojis = ["💖", "💕", "🌸", "✨", "🎀"] }) {
  const hearts = reactExports.useMemo(
    () => Array.from({ length: count }).map((_, i) => ({
      id: i,
      left: Math.random() * 100,
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "pointer-events-none fixed inset-0 overflow-hidden z-0", children: hearts.map((h) => /* @__PURE__ */ jsxRuntimeExports.jsx(
    "span",
    {
...
function Index() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("main", { className: "relative min-h-screen", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(FloatingHearts, { count: 20 }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(MusicToggle, { autoPlay: entered }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(AnimatePresence, { mode: "wait", children: !entered ? /* @__PURE__ */ jsxRuntimeExports.jsx(Landing, { onEnter: () => setEntered(true) }, "landing") : /* @__PURE__ */ jsxRuntimeExports.jsx(Experience, { onReplay: () => setEntered(false) }, "exp") })
  ] });
}
export {
  Index as component
