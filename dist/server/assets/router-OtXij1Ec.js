...
const appCss = "/assets/styles-DPVBJzjJ.css";
function NotFoundComponent() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex min-h-screen items-center justify-center bg-background px-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-md text-center", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-7xl font-bold text-gradient-rose font-display", children: "404" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "mt-4 text-xl font-semibold", children: "This page got lost in the confetti 🎊" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-6", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/", className: "inline-flex items-center justify-center rounded-full gradient-rose px-6 py-3 text-sm font-medium text-white", children: "Back to the surprise 💖" }) })
  ] }) });
}
const Route$1 = createRootRoute({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "A magical birthday surprise" }
    ],
    links: [
      { rel: "stylesheet", href: appCss },
      { rel: "preconnect", href: "https://fonts.googleapis.com" },
      { rel: "preconnect", href: "https://fonts.gstatic.com", crossOrigin: "anonymous" },
      { rel: "stylesheet", href: "https://fonts.googleapis.com/css2?family=Playfair+Display:wght@500;700;900&family=Dancing+Script:wght@500;700&family=Quicksand:wght@400;500;600&display=swap" }
    ]
  }),
...
const $$splitComponentImporter = () => import("./index-BwQ3Qxek.js");
const Route2 = createFileRoute("/")({
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "A magical, dreamy birthday surprise full of love, memories, and confetti — made with all my heart for my best friend."
    }, {
      property: "og:title",
      content: "Happy Birthday, Bestie 💖"
    }, {
      property: "og:description",
      content: "A magical birthday surprise made with love."
    }, {
      property: "og:type",
      content: "website"
    }]
